...
public class PullToRefreshView extends LinearLayout {
    ...
    private void init() {
        ...
        // mReverseFlipAnimation.setBackgroundColor(MyApplication.getInstance().getResources().getColor(R.color.red));
    ...
    */
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mScrollView != null) {
            ...
            if (deltaY > 0 && mScrollView.getScrollY() == 0 && canPullDown) {
                mPullState = PULL_DOWN_STATE;
                return true;
            } else if (deltaY < 0 && child.getMeasuredHeight() <= getHeight() + mScrollView.getScrollY() && canPullUp) {
                mPullState = PULL_UP_STATE;
                return true;
            }
        }
