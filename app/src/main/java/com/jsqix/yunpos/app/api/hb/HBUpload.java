...
public abstract class HBUpload extends AsyncTask<String, String, String> {
    String response = "";
    int resultCode = 0;
    ...
    public HBUpload(Context context, Map<String, String> params,
    ...
    private void OkHttpPost(String url)
        ...
        response = httpClientTool.uploadImg(url, postMap);
