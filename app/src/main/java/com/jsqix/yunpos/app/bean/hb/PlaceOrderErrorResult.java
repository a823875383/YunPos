...
/**
 * Created by dongqing on 2016/11/20.
 */

public class PlaceOrderErrorResult {

    /**
     * RSP_ID : FAL1
     * TXN_CD : MWB0101034
     * RSP_PAG : /common/jsp/json.jsp
     * GWA : {"CUR_AC_DT":"20160310","TMSG_INF":"用户所在归属省没有开通电子券商品购买功能","MON_FLG":"0","TX_TYP":"","MBL_NO":"","LAST_AC_DT_FLG":"D","TRM_ID":"","LOG":{"MSG_ID":"OMKMWEB1MKMWEB033000001792480","STE":"[Application:[MKM](TID000000000000003012), Transaction:[MWB0101034](TID000000000000005819), Exec:[PUB:GWASetMsg](TID000000000000005842)]","REG_ID":"MKMWEB34","END_TM":"1479649936238","NOD_ID":"MKMWEB","TX_CD":"MWB0101034","SVR_NM":"OMKMWEB1"},"CNL_TX_CD":"","OPR_ID":"","MSG_DAT":"用户所在归属省没有开通电子券商品购买功能","TX_CD":"MWB0101034","ERR_NUM":"1","OLD_JRN_NO":"","JRN_SEQ":"1","MSG_TYP":"E","MSG_CD":"MKM01016","LAST_AC_DT2_FLG":"D","MSG_INF":"用户所在归属省没有开通电子券商品购买功能","VIEWCODE":"json","ERR":[{"TMSG_INF":"用户所在归属省没有开通电子券商品购买功能","MSG_TYP":"E","MSG_CD":"MKM01016","MSG_INF":"用户所在归属省没有开通电子券商品购买功能"}],"DOMAIN":"www.cmpay.com","AC_DT":"20160310","BUS_TYP":"","PRD_CD":"","LAST_AC_DT":"20310708","TX_DT":"20161120","WIN_SW_TM":"000000","VER_NO":"V1.0.0","WIN_MOD":"1","CUR_AC_DT_FLG":"D","WIN_STS":"B","TX_TM":"215208","NEXT_AC_DT":"20310801","SYS_CNL":"CMPAY","NEXT_AC_DT_FLG":"D","TX_AMT":"","AP_CD":"","WIN_DT2":"20310801","TXN_MOD":"O","WIN_BEG_TM":"080000","WIN_DT1":"20310731","JRN_NO":"201603100767051635","BUS_CNL":"CMPAY","WIN_END_TM":"020000","LAST_AC_DT2":"20310707"}
     */
    ...
    public static class GWABean {
        /**
         * CUR_AC_DT : 20160310
         * TMSG_INF : 用户所在归属省没有开通电子券商品购买功能
         * MON_FLG : 0
         * TX_TYP :
         * MBL_NO :
         * LAST_AC_DT_FLG : D
         * TRM_ID :
         * LOG : {"MSG_ID":"OMKMWEB1MKMWEB033000001792480","STE":"[Application:[MKM](TID000000000000003012), Transaction:[MWB0101034](TID000000000000005819), Exec:[PUB:GWASetMsg](TID000000000000005842)]","REG_ID":"MKMWEB34","END_TM":"1479649936238","NOD_ID":"MKMWEB","TX_CD":"MWB0101034","SVR_NM":"OMKMWEB1"}
         * CNL_TX_CD :
         * OPR_ID :
         * MSG_DAT : 用户所在归属省没有开通电子券商品购买功能
         * TX_CD : MWB0101034
         * ERR_NUM : 1
         * OLD_JRN_NO :
         * JRN_SEQ : 1
         ...
         * MSG_CD : MKM01016
         * LAST_AC_DT2_FLG : D
         * MSG_INF : 用户所在归属省没有开通电子券商品购买功能
         * VIEWCODE : json
         * ERR : [{"TMSG_INF":"用户所在归属省没有开通电子券商品购买功能","MSG_TYP":"E","MSG_CD":"MKM01016","MSG_INF":"用户所在归属省没有开通电子券商品购买功能"}]
        ...
        private String TMSG_INF;
        private String MON_FLG;
        ...
        public String getTMSG_INF() {
            return TMSG_INF;
        }

        public void setTMSG_INF(String TMSG_INF) {
            this.TMSG_INF = TMSG_INF;
        }

        public String getMON_FLG() {
            return MON_FLG;
        }

        public void setMON_FLG(String MON_FLG) {
            this.MON_FLG = MON_FLG;
        }
        ...
        public List<ERRBean> getERR() {
            return ERR;
        }

        public void setERR(List<ERRBean> ERR) {
            this.ERR = ERR;
        }

        public static class LOGBean {
            /**
             * MSG_ID : OMKMWEB1MKMWEB033000001792480
