...
function bnpDivRemTo(n, h, g) {
	...
	while (--s >= 0) {
		var c = (g[--u] == b) ? this.DM : Math.floor(g[u] * A + (g[u - 1] + x)
				* z);
...
var rng_psize = 256;
var Cmpay = Cmpay || {};
Cmpay.cmN = "";
Cmpay.cmE = "10001";
doEncrypt = function(a,b) {
				var f = b;
				var i = a;
				var g = i;
				i += "" + f;
...
function RSAKey() {
	this.n = parseBigInt(Cmpay.cmN, 16);
	this.e = parseInt(Cmpay.cmE, 16);
	this.d = null;
	this.p = null;
	this.q = null;
	this.dmp1 = null;
